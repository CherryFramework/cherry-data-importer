...
if ( ! class_exists( 'Cherry_Data_Importer_Session_Cache' ) ) {

	/**
	 * Define Cherry_Data_Importer_Session_Cache class
	 */
	class Cherry_Data_Importer_Session_Cache extends Cherry_Data_Importer_Cache_Handler {
